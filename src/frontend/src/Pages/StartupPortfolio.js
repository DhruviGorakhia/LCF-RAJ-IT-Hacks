...
const rows = [
    createData("Anmol", "Elctric vehicles", "25th Jan", "1000"),
    createData("Dhruvi", "Green Energy", "26th Jan", "1500"),
    createData("Piyush", "Healthtech", "27th Jan", "1799"),
    createData("Kunal", "Edtech", "28th Jan", "1890"),
    createData("Margi", "Fintech", "29th Jan", "2000"),
];

export default function SatrtupPortfolio() {
    return (
        <>
            <Navs />
    ...
    <div className=" absolute bg-white  text-center rounded-lg"><h1 className='totalPortfolio w-2/4 absolute rounded-lg'> Total Invested :  &#8377; 50000 </h1></div> */}
            <div className="portfolio-title ">
                <div className="folio-box">
                    <h1> Funding Received : </h1>
                    <p>Total Invested : &#8377; 50000</p>
                </div>
            </div>
            <div className="portfolio-details  ">
                <div className="left">
                    <h2>Latest Funding Round  : </h2>
                    <hr />
